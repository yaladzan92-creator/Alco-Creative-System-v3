...
`;
  ...
  const handleAuth = (e: React.FormEvent) => {
    ...
    if (password === config.developerPassword) {
      ...
      toast.success("Sesi Pengaturan Lanjutan Berhasil");
    } else {
      toast.error("Kata sandi akses tidak valid");
    }
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success("Konfigurasi sistem berhasil diterapkan");
    } catch (e) {
  ...
  const rollback = async () => {
    if (!config.rollbackConfig) {
      toast.error("Tidak ada poin pemulihan");
      return;
    }
    if (confirm("Kembalikan ke konfigurasi sebelumnya?")) {
      setLoading(true);
      try {
        await updateConfig(config.rollbackConfig as AppConfig);
        toast.success("Berhasil dikembalikan (rollback)");
      } catch (e) {
        ...
        >
          <Card className="border-white/10 bg-slate-900 text-white overflow-hidden shadow-2xl rounded-[3rem]">
            <CardHeader className="bg-slate-800/50 p-10 border-b border-white/5 text-center">
              ...
              <CardTitle className="text-3xl font-heading font-black tracking-tight uppercase">Alat Sistem Lanjutan</CardTitle>
              <p className="text-[10px] text-primary font-black uppercase tracking-[0.2em] mt-2">Autentikasi Diperlukan</p>
            </CardHeader>
            <CardContent className="p-10">
              <form onSubmit={handleAuth} className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Kata Sandi Akses Lanjutan</Label>
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-border p-6 px-10 flex flex-col md:flex-row justify-between items-center gap-6 shadow-sm">
         <div className="flex items-center gap-4">
            ...
            <div>
               <h1 className="text-2xl font-heading font-black tracking-tight uppercase leading-none">
                  Alat Sistem Lanjutan
               </h1>
               <div className="flex items-center gap-2 mt-1">
                  <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                  <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground">
                     Sesi Pengaturan Lanjutan
                  </p>
               </div>
            </div>
         </div>
         ...
         <div className="flex gap-3">
            {accessLevel === "full" && (
              ...
              >
                 <History className="w-4 h-4" /> Pulihkan Konfigurasi
              </Button>
            )}
            <Button 
              onClick={handleSave} 
      ...
      <div className="max-w-7xl mx-auto p-10 grid grid-cols-1 lg:grid-cols-12 gap-12">
         ...
         <div className="lg:col-span-3 space-y-2">
            {[
              { id: "ai", label: "AI & Kecerdasan", icon: BrainCircuit, show: accessLevel === "full" },
              { id: "apiHub", label: "Pusat Integrasi API", icon: FileCode, show: accessLevel === "full" },
              { id: "workflow", label: "Alur Inti Aplikasi", icon: Workflow, show: accessLevel === "full" },
              { id: "security", label: "Keamanan & Akses", icon: Key, show: accessLevel === "full" },
              { id: "infra", label: "Infrastruktur", icon: Database, show: accessLevel === "full" },
              ...
              >
                 ...
                 <div className="flex flex-col items-start">
                    ...
                    <span className={cn("text-[8px] font-bold uppercase tracking-widest opacity-40", activeTab === item.id && "opacity-70")}>Pengaturan</span>
                 </div>
                 {activeTab === item.id && (
               ...
               {activeTab === "security" && (
                 ...
                 >
                    <Card className="rounded-[2.5rem] border-border shadow-sm overflow-hidden">
                       <CardHeader className="p-8 bg-slate-50 border-b border-border">
                          <CardTitle className="text-sm font-black uppercase tracking-widest flex items-center gap-3">
                             <Lock className="w-5 h-5 text-primary" /> Kredensial Akses
                          </CardTitle>
                       </CardHeader>
                       <CardContent className="p-8 space-y-8">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                             <div className="space-y-4">
                                <Label className="text-[10px] font-black uppercase tracking-widest opacity-60">Kata Sandi Akses Lanjutan</Label>
                                ...
                                <p className="text-[8px] font-bold text-muted-foreground text-center">AKSES LENGKAP ALAT LANJUTAN</p>
                             </div>
                             <div className="space-y-4">
                                <Label className="text-[10px] font-black uppercase tracking-widest opacity-60">Kata Sandi Pengaturan Brand</Label>
                                ...
                                <p className="text-[8px] font-bold text-muted-foreground text-center">AKSES PENGATURAN BRAND SAJA</p>
                             </div>
                          </div>
                       </CardContent>
                    </Card>
                           ...
                           <div className="flex items-center gap-3">
                              ...
                              <div>
                                 <CardTitle className="text-sm font-black uppercase tracking-widest text-primary">
                                    Asisten Diagnostik Sistem
                                 </CardTitle>
                                 <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider mt-0.5">Asisten Pengatur & Penguji Sistem Lanjutan</p>
                              </div>
                           </div>
